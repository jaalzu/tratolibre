  ...
  return (
    <>
      <Box
        ...
        borderTop="1px solid" borderBottom="1px solid" borderColor="neutral.200"
      >
        {/* Filtros */}
        <Flex
          as="button"
          ...
          position="relative"
        >
          <i className="bx bx-slider-alt" style={{ fontSize: '18px', color: 'var(--chakra-colors-neutral-600)' }} />
          <Text fontSize="sm" fontWeight="medium" color="neutral.700">Filtros</Text>
          {hasFilters && (
            <Box
              w="7px" h="7px" borderRadius="full" bg="brand.default"
        ...
        <Flex
          ...
          _hover={{ bg: 'neutral.50' }}
        >
          <i className="bx bx-sort" style={{ fontSize: '18px', color: 'var(--chakra-colors-neutral-600)' }} />
