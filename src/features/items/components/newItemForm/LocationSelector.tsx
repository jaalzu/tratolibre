...
interface LocationSelectorProps {
  ...
  setValue: UseFormSetValue<ItemFormInput>;
}
...
export const LocationSelector = ({
  ...
  useEffect(() => {
    fetch(
      "https://apis.datos.gob.ar/georef/api/provincias?orden=nombre&campos=id,nombre&max=100",
    )
      .then((r) => r.json())
  ...
  useEffect(() => {
    ...
    fetch(
      `https://apis.datos.gob.ar/georef/api/municipios?provincia=${selectedProvince}&orden=nombre&campos=id,nombre&max=200`,
    )
      .then((r) => r.json())
