  ...
  return (
    <SimpleGrid  columns={{ base: 1, sm: 2 }} gap={4}>
      <MetricCard
        ...
        secondary={{ value: `+${metrics.newUsers}`, label: 'nuevos esta semana' }}
      />
      <MetricCard
        title="Publicaciones"
        icon="bx-package"
        primary={{ value: metrics.totalItems, label: 'publicaciones activas' }}
        secondary={{ value: `+${metrics.newItems}`, label: 'nuevas esta semana' }}
      />
      <MetricCard
        title="Ventas"
        icon="bx-trending-up"
      ...
      <MetricCard
        title="Reportes"
        icon="bx-flag"
        primary={{ value: metrics.pendingReports, label: 'reportes pendientes' }}
