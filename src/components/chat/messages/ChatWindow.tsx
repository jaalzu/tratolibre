...
export const ChatWindow = ({ conversationId, userId, type }: ChatWindowProps) => {
  const { messages, loading, input, setInput, sending, sendMessage, bottomRef } = useChat(conversationId, userId, type)
  ...
  <Box flex="1" minH="0" overflowY="auto">
    <ChatMessages messages={messages} userId={userId} bottomRef={bottomRef} />
  </Box>
  <Box flexShrink={0}>
