        ...
        >
          ...
          <Stack gap={4} color="fg.muted" lineHeight="tall">
            <Text>
              ...
              usás pueden ser exactamente lo que otra persona está buscando. En
              Argentina, millones de artículos terminan guardados o descartados
              cuando podrían seguir circulando y generando valor.
            </Text>
            <Text>
              Creamos una plataforma donde comprar, vender e intercambiar
              objetos usados sea tan fácil como hablar con un vecino. Sin
              comisiones ocultas, sin procesos complicados. Solo personas
              conectadas por el deseo de hacer tratos justos.
            </Text>
            <Text>
              Hoy TratoLibre reúne a una comunidad creciente en todo el país,
              desde grandes ciudades hasta pueblos pequeños, donde cada
              publicación es una oportunidad de encontrar algo especial o
              desprenderse de lo que ya no necesitás.
            </Text>
          </Stack>
        </Box>
